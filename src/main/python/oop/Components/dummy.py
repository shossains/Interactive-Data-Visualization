...
from src.main.python.oop.Components.MainGraph import MainGraph

from src.main.python.oop.Components.Table import Table


class dummy(DashComponent):
    def __init__(self, plot_factory, df, title="Graph"):
        ...
        self.df = df
        self.MainGraph = MainGraph(plot_factory, df, "Main Graph")


    def layout(self, params=None):
        page = html.Div(self.MainGraph.layout(params))
        return page
